<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
            ...
            <div class="text-center">
                @if (Route::has('register'))
                    <a class="underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800"
                        ...
                        <i class="ms-1 text-blue-500">{{ __('Register') }}</i>
                    </a>
                @endif
            </div>
        </div>
        ...
        <div
            class="my-2 flex items-center before:mt-0.5 before:flex-1 before:border-t before:border-gray-300 after:mt-0.5 after:flex-1 after:border-t after:border-gray-300">
            <p class="mx-4 mb-0 text-center font-semibold dark:text-gray-400">OR</p>
        </div>
        ...
        <div class="flex items-center justify-center">
            <a href="{{ route('auth.google.redirect') }}"
                ...
                <svg class="w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
                    ...
                    <path fill="#1976D2"
                        d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.571l6.19,5.238C39.712,35.619,44,29.598,44,24C44,22.659,43.862,21.35,43.611,20.083z">
                    </path>
                </svg>
                Login with Google
            </a>
